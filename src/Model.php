...
class Model {
	...
	private function setLink(\ReflectionClass $ENTITY) {
		$this->link = Link::get($ENTITY);
		if(!is_null($this->link)) inject($this->link, "self", $ENTITY->getName());
	}
	...
	public function isLink(): bool { return !is_null($this->link); }
	public function getLink(): Link { return $this->link; }
